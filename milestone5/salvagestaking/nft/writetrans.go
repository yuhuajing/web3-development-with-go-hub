...
func WriteTrans(nftContract, fromAddress, operator common.Address, tokenId *big.Int, nonce int, pk *ecdsa.PrivateKey) (error, string) {
	...
	opts.GasLimit = uint64(config.NFTTransGasLimit)
